...
%   of $\Sigma$ in a suitable class of relative monads (in the sense of
%   Altenkirch, Chapman, and Uustalu).


% in dB-monads, i.e., "monads relative to" (in the sense
%   of Altenkirch, Chapman, and Uustalu)
%   the functor dB which injects into the category Set its full
%   subcategory with one object \N.

%   This high-level point of view allows us to easily extrapolate
%   several useful "fusion laws" which otherwise might be tricky to
%   devise.
